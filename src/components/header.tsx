            ...
            <div 
                ...
                <div className="
                    ...
                    <Link to={`/`} className="flex" >
                        ...
                        <a className="
                            ...
                            md:flex md:text-justify md:cursor-pointer md:text-2xl md:mt-1 md:text-black md:hover:text-black/80 md:hover:animate-pulse
                            "> Ícaro Sperandio
                        </a>
                    </Link>
                </div>
                ...
                <div className="flex flex-row dark:text-white">
                    <div className="
                        ...
                        ">
                        <button className="relative flex box-content w-auto h-0 border-none m-5 items-center content-center justify-center p-1 cursor-pointer">
                            <Link to={`/sobre`} >
                                <p className=" lg:font-normal font-bold text-2xl text-black content-end hover:text-cyan-600 hover:animate-pulse">
                                    sobre
                                </p>
                            </Link>
                        </button>
                        ...
                        <button className="relative flex box-content w-auto h-0 border-none m-1 items-center content-center justify-center p-1 cursor-pointer">
                            <Link to={`/projetos`} >
                                <p className=" lg:font-normal font-bold text-2xl text-black content-end hover:text-cyan-600 hover:animate-pulse">
                                    repositório
                                </p>
