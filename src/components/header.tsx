        ...
        <div className="
            ...
            <div className="flex flex-row dark:text-white">
                <div className="
                    ...
                    <button className="relative flex box-content w-36 h-0 border-none m-1 items-center content-center justify-center p-1 cursor-pointer">
                        <Link to={`/projetos`} >
                            <p className="font-sans lg:font-normal font-bold text-lg text-black content-end hover:text-cyan-600 hover:animate-pulse">
                                repositório gitHub
                            </p>
                ...
                <div className="flex w-1 ml-10 justify-center items-center dark:text-white"
                    onClick={darkMode}>
                    <div
